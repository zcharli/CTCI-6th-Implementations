 ...
 */
public class SeventeenFourteenLongestWord {
    ...
    public static String findLongest(List<String> words) {
        ...
        Collections.sort(words, new TreeSetComparator());
        for (String word : words) {
            if (subStringWord(word, sorted, true)) {
                return word;
            }
        }
    ...
    public static boolean subStringWord(String substring, Set<String> set, boolean isFirst) {
        ...
        for (int i = 1; i < substring.length(); i++) {
            ...
            if (set.contains(left) && subStringWord(right, set, false)) {
                return true;
            }
        }
        return false;
...
//    }
//
//    public static boolean subStringWord(String substring, Map<String, Boolean> map, boolean isFirst) {
//
//        if (map.containsKey(substring) && !isFirst) {
...
//            String left = substring.substring(0, i);
//            String right = substring.substring(i);
//            if (map.containsKey(left) && map.get(left) == true && subStringWord(right, map, false)) {
//                return true;
//            }
//        }
...
//    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(String.format("Charlies %s in %d ms", longest, duration/1000000));

        long startTime2 = System.nanoTime();
        String longest2 = printLongestWord(array);
        long endTime2 = System.nanoTime();
        long duration2 = (endTime2 - startTime2);
        System.out.println(String.format("Gails %s in %d ms", longest2, duration2/1000000));
    }

    public static class TreeSetComparator implements Comparator<String> {
...
//    This implementation used maps instead of sorted set
//    public static String findLongest(List<String> words) {
//
//        SortedMap<String, Boolean> sorted = new TreeMap<>(new LengthComparator());
//
//        for (String word : words) {
//            sorted.put(word, true);
//        }
...
//    }
//
//    public static boolean subStringWord(String substring, SortedMap<String, Boolean> map, boolean isFirst) {
//
//        if (map.containsKey(substring) && !isFirst) {
//            return map.get(substring);
//        }
